...
The gateway only merges open, non-draft PRs. PR head and target/base branches are passed through to GitHub instead of being limited by the gateway's write-branch or base-branch allowlists.
