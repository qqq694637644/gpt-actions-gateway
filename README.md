...
ARTIFACT_AZURE_BLOB_DOWNLOADER_ENABLED=true
ARTIFACT_AZURE_BLOB_MAX_CONCURRENCY=8
ARTIFACT_AZURE_BLOB_MAX_SINGLE_GET_SIZE=8MB
ARTIFACT_AZURE_BLOB_MAX_CHUNK_GET_SIZE=4MB
